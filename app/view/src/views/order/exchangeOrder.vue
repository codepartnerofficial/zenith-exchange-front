...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/order/exchangeOrder/exchangeOrder';
import 'BlockChain-ui/PC/common-mixin/order/exchangeOrder/exchangeOrder.styl';
