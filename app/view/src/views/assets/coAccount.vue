...
<template>
  <section class="page-coAccount">
    ...
    <div class="exchangeAccount-body a-7-bd">
      <div class="exchangeAccount-title a-3-bd">
        <!-- 资金列表 -->
        <!-- 未平仓合约 -->
        <div class="text b-1-cl medium">{{ $t('assets.coAccount.listTitle') }}</div>
        <div class="client f-7-cl">
