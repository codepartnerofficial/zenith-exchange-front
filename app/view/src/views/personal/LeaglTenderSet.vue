  ...
  <div class="legal-tender-set">
    ...
    >
      <div class="alertTitle b-1-cl">
        {{ this.$t("personal.alert.fiatTitle") }}
      </div>
...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/personal/LeaglTenderSet/LeaglTenderSet';
import 'BlockChain-ui/PC/common-mixin/personal/LeaglTenderSet/LeaglTenderSet.styl';
