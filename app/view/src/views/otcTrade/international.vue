  ...
  <section class="page-otcTrade a-5-bg">
    <div class="otc-page-title a-5-bg a-7-bd">
      <div class="page-title-bar b-1-cl">
        <span v-if="axiosObj.side === 'BUY'">
          {{$t('fiatdeal.navList')[2]}}
        </span>
        <span v-else>
          {{$t('fiatdeal.navList')[1]}}
        </span>
      </div>
    </div>
          ...
          <div class="otcTrade-options-trade" v-if="optionsFlag === 'even'">
              ...
              <div class="leftInp">
                <c-inputLine :promptText="leftInputOptions.promptText"
                  ...
                  <c-button type="text"
                             ...
                             @click="inputAll('left')">{{ $t('otcTrade.all') }}</c-button>
                </c-inputLine>
              </div>
              <div class="tradeIcon">
              ...
              <div class="rightInp">
                <c-inputLine :promptText="rightInputOptions.promptText"
                  ...
                  <c-button type="text"
                             ...
                             @click="inputAll('right')">{{ $t('otcTrade.all') }}</c-button>
                </c-inputLine>
              </div>
            </div>
            <!-- 资金密码 buy时 -->
            ...
            <div class="options-trade-button">
              ...
              <c-button v-if="axiosObj.side === 'BUY'"
                         ...
                         :loading="btnLoading"
                         @click="BtnClick">{{ $t('otcTrade.ImmediateSale') }}</c-button>
              <!-- 立即购买 -->
              <c-button v-if="axiosObj.side === 'SELL'"
                         ...
                         :loading="btnLoading"
                         @click="BtnClick">{{ $t('otcTrade.ImmediatePurchase') }}</c-button>
